...
class TestGoTravel(unittest.TestCase):
    ...
    # Test #3: Get all wishlist should return a list of json with a status code 200
    ...
    # Test #4: Create an empty wishlist should return an error message with a status code 400
    ...
    # Test #5: Create a new (non-existing) wishlist should return a success message with a status code 201
    ...
    # Test #6: Create an existing wishlist should return a success message with a status code 201
